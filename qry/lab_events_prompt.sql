SELECT
	...
	CE_LAB.EVENT_ID AS EVENT_ID,
	TO_CHAR(pi_from_gmt(CE_LAB.EVENT_END_DT_TM, (pi_time_zone(1, @Variable('BOUSER')))), 'YYYY-MM-DD"T"HH24:MI:SS') AS LAB_DATETIME,
	CV_LAB.DISPLAY AS LAB,
	CE_LAB.RESULT_VAL AS LAB_RESULT,
	CV_LAB_UNITS.DISPLAY AS LAB_UNITS
FROM
	CLINICAL_EVENT,
	CLINICAL_EVENT CE_LAB,
	CODE_VALUE CV_LAB,
	CODE_VALUE CV_LAB_UNITS,
	ENCOUNTER
WHERE
	...
	AND (
		CLINICAL_EVENT.ENCNTR_ID = CE_LAB.ENCNTR_ID
		AND CE_LAB.EVENT_CD IN (31854, 31609, 114723, 31608, 32123, 19133961, 1640421961, 33949, 33977, 34189)
		AND CE_LAB.EVENT_CD = CV_LAB.CODE_VALUE
		AND CE_LAB.RESULT_UNITS_CD = CV_LAB_UNITS.CODE_VALUE
	)
	AND (
